...
class MaxHeap(Scene):
    def construct(self):
        ...
        array1 = createDataFixedWidth(21, 3)
        ...
        array2 = createDataFixedWidth(19, 3)
        ...
        tree3 = createNode(49)
        tree1_tree3 = Line(start=tree1, end=tree3)
        tree1_tree3.scale(1.7)
        array3 = createDataFixedWidth(49, 3)
        array3.shift(RIGHT * 5)
        self.play(Write(tree3), Write(array3), Write(tree1_tree3), run_time=1)
        self.wait(0.4)
        ...
        tree2_tree4 = Line(start=tree2, end=tree4)
        tree2_tree4.scale(1.2)
        ...
        tree3_tree5 = Line(start = tree3, end = tree5)
        tree3_tree5.scale(1.2)
        array5 = createDataFixedWidth(12, 3)
        array5.shift(RIGHT * 5 + DOWN * 2)
        self.play(Write(tree5), Write(array5), Write(tree3_tree5), run_time=1)
        self.wait(0.4)
        self.play(FadeToColor(tree5[1], BLUE))

        tree6 = createNode(67)
        tree6.shift(LEFT + DOWN * 2)
        tree1_tree6 = Line(start=tree1, end=tree6)
        tree1_tree6.scale(1.2)
        array6 = createDataFixedWidth(67, 3)
        array6.shift(RIGHT * 5 + DOWN * 3)
        self.play(Write(tree6), Write(array6), Write(tree1_tree6), run_time=1)
        self.wait(0.4)

        swap(tree1, tree6)
        swap(array1, array6)
        play_swap(self, tree1, array1, tree6, array6)
        self.wait(0.4)
